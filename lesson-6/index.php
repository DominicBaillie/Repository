...
<!-- STEP 3: Build a NAV element for global Web site navigation -->
			<nav>
				<ul>
					...
					<li><a href = "red.pfp" >Red Blocks</a></li>
					<li><a href = "yellow.php">Yellow Blocks</a></li>
					<li><a href = "blue.pfp" >Blue Blocks</a></li>
				</ul>
			</nav>
...
<!-- STEP 1a: Build an A (anchor) element that surrounds the word 'LEGO®' inside the FIGCAPTION below -->
					<figcaption><a href="https://www.lego.com/" rel= "external" title = "Go to Official LEGO Web Site">LEGO®</a> mini figure by Vanja (Public Domain)</figcaption>
...
<!-- STEP 8a: Create a NAV element in the FOOTER for the legal stuff -->
			<nav>
				<a href = "about/privacy-policy.php">Privacy Policy</a> | <a href="about/privacy-policy.php#personal-information" title="Learn about how we treat your personal information">Use of Personal Information</a>
			</nav>
